...
- (void)viewDidLoad {
    ...
    self.appKey = @"107b6adffa0149d0808c5b9f60c29684";
    self.reqIP = @"127.0.0.1";
    self.account = @"18928821637";//DX
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    switch (indexPath.row) {
        ...
        case 4:{
            ...
            alertView.alertViewStyle = UIAlertViewStylePlainTextInput;
            [alertView textFieldAtIndex:0].text = @"http://fmp.szwisdom.cn/admin/pages/image/wyzt-LOGO-s.png";
            alertView.tag = 103;
            [alertView show];
        }
            break;
        ...
        case 6:{
            ...
            alertView.alertViewStyle = UIAlertViewStylePlainTextInput;
            [alertView textFieldAtIndex:0].text = @"https://www.baidu.com";
            alertView.tag = 105;
            [alertView show];
        }
            break;
...
//        self.tableView.backgroundColor = [UIColor colorWithPatternImage:imageView.image];
